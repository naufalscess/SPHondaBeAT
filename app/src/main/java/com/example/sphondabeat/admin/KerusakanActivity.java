...
public class KerusakanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> {
            Intent intent = new Intent(KerusakanActivity.this, KerusakanTambahActivity.class);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(KerusakanActivity.this);
                    ...
                    try {
                        if (response.getInt("status") == 0) {
                            ...
                            AdapterView.OnItemClickListener itemClickListener = (parent, container, position, id) -> {
                                ...
                                Intent intent = new Intent(KerusakanActivity.this, KerusakanEditActivity.class);
                            ...
                            if (kosong) {
                                Toast.makeText(KerusakanActivity.this, "Tidak ada data kerusakan",
